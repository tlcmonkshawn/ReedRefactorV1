...
# Run migrations with explicit environment and verbose output
echo ""
echo "Running database migrations..."
echo "Using DATABASE_URL: ${DATABASE_URL:0:30}..."
echo "Working directory: $(pwd)"

# Run migrations - use rake db:migrate directly
echo "Executing migration command: bundle exec rake db:migrate"
